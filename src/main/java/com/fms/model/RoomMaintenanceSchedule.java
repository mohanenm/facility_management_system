...
public class RoomMaintenanceSchedule {
    ...
    public RoomMaintenanceSchedule(int id, int roomMaintenanceRequestId, LocalDateTime start, LocalDateTime finish) {
        this.id = id;
    ...
    public static RoomMaintenanceSchedule fromJson(String roomMaintenanceSchedule) throws IOException {
        ...
        return new RoomMaintenanceSchedule(jsonObject.get("id").getAsInt(),
