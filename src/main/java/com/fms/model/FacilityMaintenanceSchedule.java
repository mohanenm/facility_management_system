...
public class FacilityMaintenanceSchedule {
    ...
    public FacilityMaintenanceSchedule(int id, int facilityMaintenanceRequestId, LocalDateTime start, LocalDateTime finish) {
        this.id = id;
    ...
    public static FacilityMaintenanceSchedule fromJson(String facilityMaintenanceSchedule) throws IOException {
        ...
        return new FacilityMaintenanceSchedule(jsonObject.get("id").getAsInt(),
