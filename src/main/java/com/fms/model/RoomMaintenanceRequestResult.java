...
public class RoomMaintenanceRequestResult {
    public RoomMaintenanceRequestResult(RoomMaintenanceRequest roomMaintenanceRequest, String errorMessage) {
    ...
    public static RoomMaintenanceRequestResult fromJson
            (String roomMaintenanceRequestResult) throws IOException {
        ...
        RoomMaintenanceRequest roomMaintenanceRequest =
                RoomMaintenanceRequest.fromJson(
                        roomMaintenanceRequestJE.getAsJsonObject().toString());

        return new RoomMaintenanceRequestResult(roomMaintenanceRequest,
