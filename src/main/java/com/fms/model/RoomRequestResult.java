...
public class RoomRequestResult {
    ...
    public static RoomRequestResult fromJson
        ...
        RoomRequest roomRequest =
                RoomRequest.fromJson(
                        roomRequestJE.getAsJsonObject().toString());

        return new RoomRequestResult(roomRequest,
    ...
    public boolean equals(Object o) {
        ...
        return ((roomRequest == null && g.roomRequest == null) ||
                roomRequest.equals(g.roomRequest)) &&
