...
public class DBUsage {
    ...
    public DBUsage() throws SQLException {
        insertRoomRequest = DBConnection
                .getConnection()
                .prepareStatement("INSERT into room_reservation " +
                        "(room_id values (?) " +
                        "RETURNING id");

        queryRoomRequest= DBConnection
                .getConnection()
    ...
    public RoomRequest makeRoomRequest (RoomReservation roomRequest)
            throws SQLException {
    ...
    public boolean scheduleRoomReservation
            (int roomId,
             Range<LocalDateTime> reservationPeriod) throws SQLException {
