...
public class MaintenanceServiceTest {
  ...
  @Rule public ExpectedException maintenanceException = ExpectedException.none();
  ...
  public void CRUDRoomMaintenanceRequest() throws FMSException {
    ...
    try {
      ...
      if (facility != null) facilityService.removeFacility(facility.getId());
    }
  }
  ...
  @Test
  public void scheduleConflictingFacilityMaintenance()
      throws SQLException, FMSException, RoomSchedulingConflictException {
    ...
    try {
      ...
      assert (false
          == maintenanceService.scheduleFacilityMaintenance(
              facility.getId(), true, true, sampleRange));
  ...
  @Rule public ExpectedException schedulingConflictExpected = ExpectedException.none();

  @Test
  public void scheduleConflictingRoomMaintenance()
      throws SQLException, FMSException, RoomSchedulingConflictException {
    ...
    try {
      ...
      // Now with our room scheduled, create the conflict by scheduling maintenance
      // for the same time
      maintenanceService.scheduleRoomMaintenance(roomMaintenanceRequestId, TestData.sampleRange());
  ...
  public void calcMaintenanceCost() throws SQLException, FMSException {
    ...
    try {
      ...
      HashMap<String, Double> costResults =
          maintenanceCostCalculator.calcMaintenanceCostForFacility(
              facility.getId(), testData.sampleRange());
